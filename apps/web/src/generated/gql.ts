 ...
 */
type Documents = {
    "query PendingPhotoReports {\n  pendingPhotoReports {\n    photoId\n    title\n    imageUrl\n    thumbnailUrl\n    status\n    uploader {\n      id\n      displayName\n      email\n    }\n    reportCount\n    reasons\n    details\n    latestReportedAt\n  }\n}\n\nmutation ModeratePlacePhoto($photoId: ID!, $action: PlacePhotoModerationAction!) {\n  moderatePlacePhoto(photoId: $photoId, action: $action) {\n    photoId\n    action\n  }\n}": typeof types.PendingPhotoReportsDocument,
    "mutation ReportSharedRoute($routeId: ID!, $reason: SharedRouteReportReason!, $details: String) {\n  reportSharedRoute(routeId: $routeId, reason: $reason, details: $details) {\n    id\n    routeId\n    reason\n    details\n    status\n    createdAt\n    updatedAt\n  }\n}\n\nquery PendingSharedRouteReports {\n  pendingSharedRouteReports {\n    routeId\n    placeTitles\n    tripDays\n    owner {\n      id\n      displayName\n      email\n    }\n    reportCount\n    reasons\n    details\n    latestReportedAt\n  }\n}\n\nmutation ModerateSharedRoute($routeId: ID!, $action: SharedRouteModerationAction!) {\n  moderateSharedRoute(routeId: $routeId, action: $action) {\n    routeId\n    action\n  }\n}": typeof types.ReportSharedRouteDocument,
    ...
    "query PlacePhotos($place: PlaceSnapshotInput!, $limit: Int) {\n  placePhotos(place: $place, limit: $limit) {\n    id\n    userId\n    isMine\n    reportedByMe\n    placeKey\n    placeKeys\n    provider\n    externalId\n    contentId\n    contentTypeId\n    title\n    address\n    lat\n    lng\n    categoryLabel\n    categoryName\n    placeImageUrl\n    regionCode\n    regionLabelKey\n    imageId\n    imageUrl\n    thumbnailUrl\n    variant\n    source\n    status\n    verifiedAt\n    createdAt\n    updatedAt\n  }\n}\n\nmutation ReportPlacePhoto($photoId: ID!, $reason: PlacePhotoReportReason!, $details: String) {\n  reportPlacePhoto(photoId: $photoId, reason: $reason, details: $details) {\n    id\n    photoId\n    reason\n    details\n    status\n    createdAt\n    updatedAt\n  }\n}\n\nmutation CancelPlacePhotoReport($photoId: ID!) {\n  cancelPlacePhotoReport(photoId: $photoId) {\n    id\n    photoId\n    status\n    updatedAt\n  }\n}": typeof types.PlacePhotosDocument,
...
const documents: Documents = {
    ...
    "mutation ReportSharedRoute($routeId: ID!, $reason: SharedRouteReportReason!, $details: String) {\n  reportSharedRoute(routeId: $routeId, reason: $reason, details: $details) {\n    id\n    routeId\n    reason\n    details\n    status\n    createdAt\n    updatedAt\n  }\n}\n\nquery PendingSharedRouteReports {\n  pendingSharedRouteReports {\n    routeId\n    placeTitles\n    tripDays\n    owner {\n      id\n      displayName\n      email\n    }\n    reportCount\n    reasons\n    details\n    latestReportedAt\n  }\n}\n\nmutation ModerateSharedRoute($routeId: ID!, $action: SharedRouteModerationAction!) {\n  moderateSharedRoute(routeId: $routeId, action: $action) {\n    routeId\n    action\n  }\n}": types.ReportSharedRouteDocument,
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "query PendingPhotoReports {\n  pendingPhotoReports {\n    photoId\n    title\n    imageUrl\n    thumbnailUrl\n    status\n    uploader {\n      id\n      displayName\n      email\n    }\n    reportCount\n    reasons\n    details\n    latestReportedAt\n  }\n}\n\nmutation ModeratePlacePhoto($photoId: ID!, $action: PlacePhotoModerationAction!) {\n  moderatePlacePhoto(photoId: $photoId, action: $action) {\n    photoId\n    action\n  }\n}"): (typeof documents)["query PendingPhotoReports {\n  pendingPhotoReports {\n    photoId\n    title\n    imageUrl\n    thumbnailUrl\n    status\n    uploader {\n      id\n      displayName\n      email\n    }\n    reportCount\n    reasons\n    details\n    latestReportedAt\n  }\n}\n\nmutation ModeratePlacePhoto($photoId: ID!, $action: PlacePhotoModerationAction!) {\n  moderatePlacePhoto(photoId: $photoId, action: $action) {\n    photoId\n    action\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation ReportSharedRoute($routeId: ID!, $reason: SharedRouteReportReason!, $details: String) {\n  reportSharedRoute(routeId: $routeId, reason: $reason, details: $details) {\n    id\n    routeId\n    reason\n    details\n    status\n    createdAt\n    updatedAt\n  }\n}\n\nquery PendingSharedRouteReports {\n  pendingSharedRouteReports {\n    routeId\n    placeTitles\n    tripDays\n    owner {\n      id\n      displayName\n      email\n    }\n    reportCount\n    reasons\n    details\n    latestReportedAt\n  }\n}\n\nmutation ModerateSharedRoute($routeId: ID!, $action: SharedRouteModerationAction!) {\n  moderateSharedRoute(routeId: $routeId, action: $action) {\n    routeId\n    action\n  }\n}"): (typeof documents)["mutation ReportSharedRoute($routeId: ID!, $reason: SharedRouteReportReason!, $details: String) {\n  reportSharedRoute(routeId: $routeId, reason: $reason, details: $details) {\n    id\n    routeId\n    reason\n    details\n    status\n    createdAt\n    updatedAt\n  }\n}\n\nquery PendingSharedRouteReports {\n  pendingSharedRouteReports {\n    routeId\n    placeTitles\n    tripDays\n    owner {\n      id\n      displayName\n      email\n    }\n    reportCount\n    reasons\n    details\n    latestReportedAt\n  }\n}\n\nmutation ModerateSharedRoute($routeId: ID!, $action: SharedRouteModerationAction!) {\n  moderateSharedRoute(routeId: $routeId, action: $action) {\n    routeId\n    action\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation UpdateRouteStartLocation($input: UpdateRouteStartLocationInput!) {\n  updateRouteStartLocation(input: $input) {\n    ...RouteDetailFields\n  }\n}"): (typeof documents)["mutation UpdateRouteStartLocation($input: UpdateRouteStartLocationInput!) {\n  updateRouteStartLocation(input: $input) {\n    ...RouteDetailFields\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
